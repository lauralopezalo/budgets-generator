                ...
                <div className="flex items-center relative overflow-hidden min-h-screen sm:min-h-fit">
                    <div className="lg:py-20">
                        ...
                        <div className="mt-16 flex items-center justify-center md:justify-start">
                            <button className="inline-block rounded-full border-2 border-tangerine bg-white font-bold text-tangerine px-4 py-1 transition duration-500 ease select-none hover:bg-tangerine hover:text-white active:bg-orange-500"><Link to='/budget'>Get started</Link></button>
                        </div>
                    </div>
                </div>
            </div>
